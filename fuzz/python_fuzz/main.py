...
rip2 = RIPFuzzTest(config_file="config.json", max_tests=10)
rip2.fuzz_metric()
rip3 = RIPFuzzTest(config_file="config.json", max_tests=10)
rip3.fuzz_command_version()
rip4 = RIPFuzzTest(config_file="config.json", max_tests=100)
rip4.fuzz_route_entries()
rip5 = RIPFuzzTest(config_file="config.json", max_tests=10)
rip5.fuzz_malformed_packets()
rip6 = RIPFuzzTest(config_file="config.json", max_tests=10)
rip6.fuzz_afi()
rip8 = RIPFuzzTest(config_file="config.json", max_tests=10)
rip8.fuzz_ip_address()
rip9 = RIPFuzzTest(config_file="config.json", max_tests=10)
rip9.fuzz_mask()
